...
def many_classifications(X, Y, sub_to_main_type, feature_order, N):
	...
	for i in range(N):
		...
		accuracy, feature_importances = one_to_many_classification(X_train, X_test, y_train, y_test, feature_order)
		list_important_features.append(feature_importances)
		list_accuracies.append(accuracy)

	return list_accuracies, list_important_features
...
def main():
	...
	list_accuracies, list_important_features = many_classifications(X_converted, Y_converted, sub_to_main_type, feature_order, N)
